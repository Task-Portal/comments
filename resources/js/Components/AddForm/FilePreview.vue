<template>
	<component :is="tag" class="file-preview">
		...
		<img  v-if="file.file.type.startsWith('image/')" :src="file.url" :alt="file.file.name" :title="file.file.name" />

		<img  v-else :src="`${text_icon}`" :alt="file.file.name" :title="file.file.name" />
...
const text_icon = `${import.meta.env.VITE_APP_URL}/storage/icons/document.jpg`;
